      ...
      <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
          ...
          >
            ...
            <div class="badge badge-success gap-2">✓ Approved</div>
            } @else {
            <div class="badge badge-warning gap-2">
              ⏳ {{ mr.approvals.currentApprovals }}/{{
                mr.approvals.requiredApprovals
              }}
              Approvals
            </div>
            } }
